...
QUESTIONS = [
  { question_group_id: 1, description: 'RubyKaigi 2024 の開催地は?', choices: ['沖縄県那覇市', '三重県津市', '福岡県福岡市', '宮城県仙台市'], answerIndex: 0, explanation: 'RubyKaigi 2024 は沖縄県那覇市で開催されました。' },
  ...
  { question_group_id: 3, description: 'プログラミング言語 Ruby の作者は?', choices: ['筒美京平', '芹澤廣明', '小田裕一郎', '松本行弘'], answerIndex: 3, explanation: 'プログラミング言語 Ruby は松本行弘氏によって開発されました。' },
...
ENGLISH_QUESTIONS = [
  { question_group_id: 1, description: 'Where was RubyKaigi 2024 held in?', choices: ['Naha, Okinawa Prefecture', 'Tsu, Mie Prefecture', 'Fukuoka, Fukuoka Prefecture', 'Sendai, Miyagi Prefecture'], answerIndex: 0, explanation: 'RubyKaigi 2024 was held in Naha, Okinawa, Japan.' },
  ...
  { question_group_id: 3, description: 'Who is the author of the Ruby programming language?', choices: ['Kyohei Tsutsumi', 'Hiroaki Serizawa', 'Yuichiro Oda', 'Yukihiro Matsumoto'], answerIndex: 3, explanation: 'The Ruby programming language was developed by Yukihiro Matsumoto.' },
